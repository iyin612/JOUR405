...
```{r}
added to the code above based off of how we did it in class. 
...
The danceability histogram shows that the data is skewed to slightly to the left, because most of the scores are concentrated towards the higher end around 0.6- 0.85. The mean is around 0.65-.67. This tells us that the average song in the dataset has a danceability of around 0.65, which means that the songs all tend to be moderately to highly danceable. The blue lines show the standard deviation above and below the mean, and most of the songs fall within this range except for a few exceptionally low danceability scores. 
